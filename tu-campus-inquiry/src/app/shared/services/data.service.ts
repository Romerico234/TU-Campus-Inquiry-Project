...
export class DataService {
  ...
  getInquiries() { return this.http.get(this.apiUrl); }

  // Fetch data from ID
  getInquiryById(id: any): Observable<InquiryData> { return this.http.get<InquiryData>(`${this.apiUrl}/${id}`); }

  // Add data to the API
  addInquiry(data: InquiryData): Observable<InquiryData> { return this.http.post<InquiryData>(this.apiUrl, data); }

  // Update data in the API
  updateInquiry(data: InquiryData) { return this.http.put(`${this.apiUrl}/${data._id}`, data); }

  // Delete data from the API
  deleteInquiry(id: any) { return this.http.delete(`${this.apiUrl}/${id}`); }

  // Mark inquiry as complete
  markInquiryAsComplete(id: string) { return this.http.put(`${this.apiUrl}/${id}`, { completed: true }); }
  ...
  clearTemporaryInquiryData() { this.inquiryData = null; }
