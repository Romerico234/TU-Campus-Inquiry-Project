...
app.get('/', (req, res) => { res.send('TU Campus Inquiry Request Server'); });
...
function gracefulShutdown() {
    if (client) { // Check if the client is defined
        client.close(false) // Close the MongoDB client connection
            .then(() => {
